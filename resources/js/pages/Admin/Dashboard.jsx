            ...
            <div className="space-y-6">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    ...
                    <div className="text-sm text-gray-500 dark:text-gray-400">
                        {t('admin.system_status', 'é‰tat actuel du systé¨me')}
                    </div>
                </div>
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <StatCard
                        ...
                        icon={AlertTriangle}
                        trend={t('admin.low_stock_desc', 'Produits < 10 unité©s')}
                ...
                <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 shadow-sm p-6">
                    <h3 className="text-lg font-semibold mb-4 text-gray-900 dark:text-gray-100">{t('admin.recent_orders', 'Commandes Ré©centes')}</h3>
