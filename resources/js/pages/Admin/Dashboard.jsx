                        ...
                        <table className="w-full text-left text-sm">
                            <thead>
                                <tr className="border-b dark:border-zinc-800 text-gray-500">
                                    <th className="py-3 px-4">{t('admin.id', 'ID')}</th>
                                    <th className="py-3 px-4">{t('admin.customer', 'Client')}</th>
                                    <th className="py-3 px-4">{t('admin.location', 'Ville')}</th>
                                    <th className="py-3 px-4">{t('admin.total', 'Total')}</th>
                                    <th className="py-3 px-4">{t('admin.status', 'Statut')}</th>
                                </tr>
                            </thead>
                            <tbody>
